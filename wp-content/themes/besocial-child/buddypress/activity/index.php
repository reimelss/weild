...
<div class="buddypress-holder">
	...
	<div class="item-list-tabs activity-type-tabs" aria-label="<?php esc_attr_e( 'Sitewide activities navigation', 'besocial' ); ?>" role="navigation">
		<ul>
			<?php
			...
			<li class="selected" id="activity-all"><a href="<?php bp_activity_directory_permalink(); ?>"><?php printf( __( 'All Affiliates %s', 'besocial' ), '<span>' . bp_get_total_member_count() . '</span>' ); ?></a></li>
            <?php } ?>
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<?php if ( bp_is_active( 'friends' ) ) : ?>
					...
					<?php if ( bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
						...
						<li <?php if ($besclwp_disable_all_members == 'true') { echo 'class="selected"'; } ?> id="activity-friends"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_friends_slug() . '/'; ?>"><?php printf( __( 'My Friends %s', 'besocial' ), '<span>' . bp_get_total_friend_count( bp_loggedin_user_id() ) . '</span>' ); ?></a></li>
				...
				<?php if ( bp_is_active( 'groups' ) ) : ?>
					...
					<?php if ( bp_get_total_group_count_for_user( bp_loggedin_user_id() ) ) : ?>
						...
						<li id="activity-groups"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_groups_slug() . '/'; ?>"><?php printf( __( 'My Groups %s', 'besocial' ), '<span>' . bp_get_total_group_count_for_user( bp_loggedin_user_id() ) . '</span>' ); ?></a></li>
				...
				<?php if ( bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) ) : ?>
					...
					<li id="activity-favorites"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/favorites/'; ?>"><?php printf( __( 'My Favorites %s', 'besocial' ), '<span>' . bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) . '</span>' ); ?></a></li>
				...
				<?php if ( bp_activity_do_mentions() ) : ?>
					...
					<li id="activity-mentions"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/mentions/'; ?>"><?php esc_html_e( 'Mentions', 'besocial' ); ?><?php if ( bp_get_total_mention_count_for_user( bp_loggedin_user_id() ) ) : ?> <strong><span><?php printf( _nx( '%s new', '%s new', bp_get_total_mention_count_for_user( bp_loggedin_user_id() ), 'Number of new activity mentions', 'besocial' ), bp_get_total_mention_count_for_user( bp_loggedin_user_id() ) ); ?></span></strong><?php endif; ?></a></li>
...
<ul id="besocial-bp-bar-left">
    <li><a href="<?php bp_sitewide_activity_feed_link(); ?>" title="<?php esc_attr_e( 'RSS Feed', 'besocial' ); ?>"><i class="fa fa-rss-square"></i></a></li>
</ul>
<ul id="besocial-bp-bar-right">
    ...
    */
    ...
    <select id="activity-filter-by">
        <option value="-1"><?php esc_html_e( '&mdash; Show Everything &mdash;', 'besocial' ); ?></option>

...
<?php
	...
	{
?>
			<span class="bps-error"><?php echo $f->error_message; ?></span>
<?php
	}
...
?>
			...
			<span> - </span>
			<input type="text" style="width: 5em;" name="<?php echo $name.'[max]'; ?>" value="<?php echo $value['max']; ?>">
<?php
	break;
	case 'integer-range':
?>
...
?>
			...
			<img id="<?php echo $id; ?>_icon" style="cursor: pointer;" src="<?php echo $icon_url; ?>" title="<?php echo $icon_title; ?>">
...
?>
			<?php foreach ($f->options as $key => $label) { ?>
				<label><input type="radio" <?php if ($key == $value) echo 'checked="checked"'; ?>
					name="<?php echo $name; ?>" value="<?php echo $key; ?>"> <?php echo $label; ?></label>
			<?php } ?>
...
<?php /*
    case 'checkbox':
			echo "<div class='checkbox besclwp-accordion-container'>\n";
			echo "<div class='besclwp-accordion-header'><strong>$f->label</strong></div>\n";
			echo "<div class='besclwp-accordion-content' style='display: none;'>\n";

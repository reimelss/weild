...
<h2 class="besocial-bp-page-title"><?php esc_attr_e( 'Profile', 'besocial' ); ?></h2>
...
<div class="item-list-tabs no-ajax" id="subnav" aria-label="<?php esc_attr_e( 'Member secondary navigation', 'besocial' ); ?>" role="navigation">
	<ul>
		...
		?>		
		    ...
		    <li><a href="<?=bp_displayed_user_link().'settings/account-admin-visibility-mode/';?>">Profile Privacy</a></li>
		<?php 
		}
		?>

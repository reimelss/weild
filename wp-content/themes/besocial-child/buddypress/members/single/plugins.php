 ...
 */
        ...
        <?php
        $pageslug = bp_current_component();

        if($pageslug == 'mutual-friends') {
        ?>
        <h2 class="besocial-bp-page-title"><?php esc_attr_e( 'Mutual Friends', 'besocial' ); ?></h2>
        <?php } ?>

        <?php if($pageslug == 'user-blog') { ?>
        <h2 class="besocial-bp-page-title"><?php esc_attr_e( 'Blog', 'besocial' ); ?></h2>
        <?php } ?>

        <?php if($pageslug != 'mutual-friends') { ?>

...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/general'; ?>" method="post" class="standard-form" id="settings-form">
	...
	<?php if ( !is_super_admin() ) : ?>
		...
		<label for="pwd"><?php esc_html_e( "Current Password", 'besocial' ); ?></label>
		<input type="password" name="pwd" id="pwd" size="16" value="" class="settings-input small" <?php bp_form_field_attributes( 'password' ); ?>/> <a style="display:none;" href="<?php echo wp_lostpassword_url(); ?>" title="<?php esc_attr_e( 'Password Lost and Found', 'besocial' ); ?>"><?php esc_html_e( 'Lost your password?', 'besocial' ); ?></a>

...
<div id="cover-image-container" class="<?php besclwp_featured_check($besclwp_member_id); ?>">
	...
	<span id="header-cover-image" href="<?php //bp_displayed_user_link(); ?>"></span>
	<div id="item-header-cover-image">
		...
		<div id="item-header-content">
            <h2 class="user-nicename"><?php echo xprofile_get_field_data('1', bp_get_member_user_id()).' '.xprofile_get_field_data('1384', bp_get_member_user_id()); ?></h2>

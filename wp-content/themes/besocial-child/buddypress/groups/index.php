...
<div class="buddypress-holder">
	...
	<form  method="post" id="groups-directory-form" class="dir-form">
		...
		<div class="item-list-tabs" aria-label="<?php esc_attr_e( 'Groups directory main navigation', 'besocial' ); ?>">
			<ul>
				<li class="selected" id="groups-all"><a href="<?php bp_groups_directory_permalink(); ?>"><?php printf( __( 'All Groups %s', 'besocial' ), '<span>' . bp_get_total_group_count() . '</span>' ); ?></a></li>

				<?php if ( is_user_logged_in() && bp_get_total_group_count_for_user( bp_loggedin_user_id() ) ) : ?>
					<li id="groups-personal"><a href="<?php echo bp_loggedin_user_domain() . bp_get_groups_slug() . '/my-groups/'; ?>"><?php printf( __( 'My Groups %s', 'besocial' ), '<span>' . bp_get_total_group_count_for_user( bp_loggedin_user_id() ) . '</span>' ); ?></a></li>
				<?php endif; ?>
		...
		<div class="item-list-tabs" id="subnav" aria-label="<?php esc_attr_e( 'Groups directory secondary navigation', 'besocial' ); ?>" role="navigation">
			<ul>
				<?php
...
<ul id="besocial-bp-bar-right">
    ...
    <select id="groups-order-by">
		...
		<option value="popular"><?php esc_html_e( 'Most Affiliates', 'besocial' ); ?></option>

...
<?php if ( bp_group_has_membership_requests( bp_ajax_querystring( 'membership_requests' ) ) ) : ?>
		...
		<?php while ( bp_group_membership_requests() ) : bp_group_the_membership_request(); ?>
			...
			<li class="item-list group-request-list">
				...
				<div class="action">
					...
					<?php bp_button( array( 'id' => 'group_membership_accept', 'component' => 'groups', 'wrapper_class' => 'accept', 'link_href' => bp_get_group_request_accept_link(), 'link_text' => __( 'Accept', 'besocial' ) ) ); ?>

					<?php bp_button( array( 'id' => 'group_membership_reject', 'component' => 'groups', 'wrapper_class' => 'reject', 'link_href' => bp_get_group_request_reject_link(), 'link_text' => __( 'Reject', 'besocial' ) ) ); ?>
	...
	<?php else: ?>
		...
		<div id="message" class="info">
			<p><?php esc_html_e( 'There are no pending affiliate membership requests.', 'besocial' ); ?></p>
		</div>

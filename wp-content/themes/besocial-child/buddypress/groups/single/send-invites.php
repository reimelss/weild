...
if ( bp_get_new_group_invite_friend_list() ) : ?>
	...
	<h2 class="bp-screen-reader-text"><?php esc_html_e( 'Send invites', 'besocial' ); ?></h2>
	...
	<form action="<?php bp_group_send_invite_form_action(); ?>" method="post" id="send-invite-form" class="standard-form">
		...
		<div class="submit">
			<input type="submit" name="submit" id="submit" value="<?php esc_attr_e( 'Send Invites', 'besocial' ); ?>" />
		</div>
...
elseif ( 0 == bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
	...
	<div id="message" class="info">
		<p class="notice"><?php esc_html_e( 'Group invitations can only be extended to friends.', 'besocial' ); ?></p>
		<p class="message-body"><?php esc_html_e( "Once you've made some friendships, you'll be able to invite those members to this group.", 'besocial' ); ?></p>
	</div>
...
/* The user does have friends, but none are eligible to be invited to this group. */
	...
	<div id="message" class="info">
		<p class="notice"><?php esc_html_e( 'All of your friends already belong to this group.', 'besocial' ); ?></p>
	</div>

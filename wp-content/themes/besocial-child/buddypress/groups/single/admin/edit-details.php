...
<h2 class="bp-screen-reader-text"><?php esc_html_e( 'Manage Group Details', 'besocial' ); ?></h2>
...
<p>
	<label for="group-notify-members">
		<input type="checkbox" name="group-notify-members" id="group-notify-members" value="1" /> <?php esc_html_e( 'Notify group affiliates of these changes via email', 'besocial' ); ?>
	</label>
</p>

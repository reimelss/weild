...
<?php if ( bp_has_forum_topics( bp_ajax_querystring( 'forums' ) ) ) : ?>
	...
	<table class="forum">
		<thead>
			<tr>
				<th id="th-title"><?php esc_html_e( 'Topic', 'besocial' ); ?></th>
				<th id="th-postcount"><?php esc_html_e( 'Posts', 'besocial' ); ?></th>
				<th id="th-freshness"><?php esc_html_e( 'Freshness', 'besocial' ); ?></th>
		...
		<tbody>
			...
			<tr class="<?php bp_the_topic_css_class(); ?>">
				<td class="td-title">
					<a class="topic-title" href="<?php bp_the_topic_permalink(); ?>" title="<?php esc_attr_e( 'Permanent link to this post', 'besocial' ); ?>">
					...
					<p class="topic-meta">
						<span class="topic-by"><?php /* translators: "started by [poster] in [forum]" */ printf( __( 'Started by %1$s', 'besocial' ), bp_get_the_topic_poster_avatar( 'height=20&width=20') . bp_get_the_topic_poster_name() ); ?></span>
						...
						<?php if ( !bp_is_group_forum() ) : ?>
							...
							<span class="topic-in">
								...
								<?php
									...
									printf( __( 'in %1$s', 'besocial' ), $topic_in );
								?>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php esc_html_e( 'Sorry, there were no forum topics found.', 'besocial' ); ?></p>
	</div>

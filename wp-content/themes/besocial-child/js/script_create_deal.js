(function ($) {
	...
	***
	********/
	$(".acf-field-5cf2efe443032 ").ready(function(){
		
		$(".acf-field-5cf2efe443032 a:contains(10 Energy)").css({'margin-left': '0', 'font-weight': '600', 'font-size': '17px', 'display':'block'});
		$(".acf-field-5cf2efe443032 a:contains(15 Materials)").css({'margin-left': '0', 'font-weight': '600', 'font-size': '17px', 'display':'block'});
		$(".acf-field-5cf2efe443032 a:contains(20 Industrials)").css({'margin-left': '0', 'font-weight': '600', 'font-size': '17px', 'display':'block'});
		$(".acf-field-5cf2efe443032 a:contains(25 Consumer Discretionary)").css({'margin-left': '0', 'font-weight': '600', 'font-size': '17px', 'display':'block'});
		$(".acf-field-5cf2efe443032 a:contains(30 Consumer Staples)").css({'margin-left': '0', 'font-weight': '600', 'font-size': '17px', 'display':'block'});
		$(".acf-field-5cf2efe443032 a:contains(35 Health Care)").css({'margin-left': '0', 'font-weight': '600', 'font-size': '17px', 'display':'block'});
		$(".acf-field-5cf2efe443032 a:contains(40 Financials)").css({'margin-left': '0', 'font-weight': '600', 'font-size': '17px', 'display':'block'});
		$(".acf-field-5cf2efe443032 a:contains(45 Information Technology)").css({'margin-left': '0', 'font-weight': '600', 'font-size': '17px', 'display':'block'});
		$(".acf-field-5cf2efe443032 a:contains(50 Communication Services)").css({'margin-left': '0', 'font-weight': '600', 'font-size': '17px', 'display':'block'});
		$(".acf-field-5cf2efe443032 a:contains(55 Utilities)").css({'margin-left': '0', 'font-weight': '600', 'font-size': '17px', 'display':'block'});
		$(".acf-field-5cf2efe443032 a:contains(60 Real Estate)").css({'margin-left': '0', 'font-weight': '600', 'font-size': '17px', 'display':'block'});
	});
	...
	********/
	...
	$(".industry-expertise").ready(function(){
		...
		if($('ul.industry-expertise li').is('ul.industry-expertise li.energy, ul.industry-expertise li.materials, ul.industry-expertise li.industrials, ul.industry-expertise li.consumerdiscretionary, ul.industry-expertise li.consumerstaples, ul.industry-expertise li.healthcare, ul.industry-expertise li.financials, ul.industry-expertise li.informationtechnology, ul.industry-expertise li.communicationservices, ul.industry-expertise li.utilities, ul.industry-expertise li.realestate') ) {
			...
			// Second Level
			$('.acf-field_5cf2efe443032').css({'margin-left': '20px', 'font-weight': '400', 'font-size': '17px'});
			$('#acf-field_5cf2efe443032-10-Energy').css({'margin-left': '0px', 'font-weight': '600', 'font-size': '18px'});
...
// 	// 20 Industrials
	...
	var fields_list25 = $("[value^='Specialty Retail'],[value^='Multiline Retail'], [value^='Internet & Direct Marketing Retail'], [value^='Distributors'],[value^='Media'], #field_3311_32, [value^='Diversified Consumer Services'], [value^='Hotels, Restaurants & Leisure'], [value^='Textiles, Apparel & Luxury Goods'], [value^='Leisure Products'], [value^='Household Durables'], [value^='Automobiles'], [value^='Auto Components']");
...
// 50 Communication Services
	...
	********/
	...
	var allPrivatePlacement = $("[value='Lending Facilities'], [value='Debt'], [value='Taxable'], [value='Tax-Exempt'] , [value='Mortgage'], [value='Mortgage Backed'], [value='Asset-Backed'],[value='Preferred'],[value='Convertible Securities'] , #field_3419_13, #field_3418_12 , [value='Equity'], [value='Stock and Sr.'], #field_3422_16 , #field_3423_17 , [value='Funds'], [value='PE Funds'], [value='Venture Capital Funds'], [value='Hedge Funds'], [value='BDCs'], [value='REITs']");
	...
	// field_3418_12 == mortagage
	// field_3419_13 == asset-backed 
    var debt = $("[value='Taxable'],[value='Tax-Exempt'],[value='Mortgage'],[value='Mortgage Backed'],[value='Asset-Backed'], #field_3418_12 ,#field_3419_13");
    ...
    var equity = $("[value='Stock and Sr.'],[value='Preferred'],[value='Convertible Securities'], #field_3422_16 , #field_3423_17 , field_3423_17");

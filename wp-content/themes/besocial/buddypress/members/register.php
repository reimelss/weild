	...
	<div class="page" id="register-page">
		...
		<?php if ( 'registration-disabled' == bp_get_current_signup_step() ) : ?>
			...
			do_action( 'bp_before_registration_disabled' ); ?>
				...
				<p><?php esc_html_e( 'User registration is currently not allowed.', 'besocial' ); ?></p>
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<p><?php esc_html_e( 'Registering for this site is easy. Just fill in the fields below, and we\'ll get a new account set up for you in no time.', 'besocial' ); ?></p>
			...
			<div class="register-section" id="basic-details-section">
				...
				<h2><?php esc_html_e( 'Account Details', 'besocial' ); ?></h2>

				<label for="signup_username"><?php esc_html_e( 'Username', 'besocial' ); ?> <?php esc_html_e( '(required)', 'besocial' ); ?></label>
				<?php
				...
				<label for="signup_email"><?php esc_html_e( 'Email Address', 'besocial' ); ?> <?php esc_html_e( '(required)', 'besocial' ); ?></label>
				<?php
				...
				<label for="signup_password"><?php esc_html_e( 'Choose a Password', 'besocial' ); ?> <?php esc_html_e( '(required)', 'besocial' ); ?></label>
				<?php
				...
				<label for="signup_password_confirm"><?php esc_html_e( 'Confirm Password', 'besocial' ); ?> <?php esc_html_e( '(required)', 'besocial' ); ?></label>
				<?php
			...
			<?php if ( bp_is_active( 'xprofile' ) ) : ?>
				...
				<div class="register-section" id="profile-details-section">
					...
					<h2><?php esc_html_e( 'Profile Details', 'besocial' ); ?></h2>
						...
						<div<?php bp_field_css_class( 'editfield' ); ?>>
							...
							if ( bp_current_user_can( 'bp_xprofile_change_field_visibility' ) ) : ?>
								<p class="field-visibility-settings-toggle" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id() ?>">
									...
									?>
									<a href="#" class="visibility-toggle-link"><?php _ex( 'Change', 'Change profile field visibility level', 'besocial' ); ?></a>
								</p>
			...
			<?php if ( bp_get_blog_signup_allowed() ) : ?>
				...
				<div class="register-section" id="blog-details-section">
					...
					<h2><?php esc_html_e( 'Blog Details', 'besocial' ); ?></h2>

					<p><label for="signup_with_blog"><input type="checkbox" name="signup_with_blog" id="signup_with_blog" value="1"<?php if ( (int) bp_get_signup_with_blog_value() ) : ?> checked="checked"<?php endif; ?> /> <?php esc_html_e( 'Yes, I\'d like to create a new site', 'besocial' ); ?></label></p>

					<div id="blog-details"<?php if ( (int) bp_get_signup_with_blog_value() ) : ?>class="show"<?php endif; ?>>

						<label for="signup_blog_url"><?php esc_html_e( 'Blog URL', 'besocial' ); ?> <?php esc_html_e( '(required)', 'besocial' ); ?></label>
						<?php
						...
						<label for="signup_blog_title"><?php esc_html_e( 'Site Title', 'besocial' ); ?> <?php esc_html_e( '(required)', 'besocial' ); ?></label>
						<?php
						...
						<fieldset class="register-site">
							<legend class="label"><?php esc_html_e( 'Privacy: I would like my site to appear in search engines, and in public listings around this network.', 'besocial' ); ?></legend>
							<?php
							...
							<label for="signup_blog_privacy_public"><input type="radio" name="signup_blog_privacy" id="signup_blog_privacy_public" value="public"<?php if ( 'public' == bp_get_signup_blog_privacy_value() || !bp_get_signup_blog_privacy_value() ) : ?> checked="checked"<?php endif; ?> /> <?php esc_html_e( 'Yes', 'besocial' ); ?></label>
							<label for="signup_blog_privacy_private"><input type="radio" name="signup_blog_privacy" id="signup_blog_privacy_private" value="private"<?php if ( 'private' == bp_get_signup_blog_privacy_value() ) : ?> checked="checked"<?php endif; ?> /> <?php esc_html_e( 'No', 'besocial' ); ?></label>
						</fieldset>
			...
			<div class="submit">
				<input type="submit" name="signup_submit" id="signup_submit" value="<?php esc_attr_e( 'Complete Sign Up', 'besocial' ); ?>" />
			</div>
		...
		<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
			...
			<div id="template-notices" role="alert" aria-atomic="true">
				<?php if ( bp_registration_needs_activation() ) : ?>
					<p><?php esc_html_e( 'You have successfully created your account! To begin using this site you will need to activate your account via the email we have just sent to your address.', 'besocial' ); ?></p>
				<?php else : ?>
					<p><?php esc_html_e( 'You have successfully created your account! Please log in using the username and password you have just created.', 'besocial' ); ?></p>
				<?php endif; ?>
			</div>

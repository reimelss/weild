...
<h2 class="besocial-bp-page-title"><?php esc_attr_e( 'Messages', 'besocial' ); ?></h2>
...
<div id="besocial-message-search" class="message-search"><?php bp_message_search_form(); ?></div>
<div class="clear"></div>
<?php endif; ?>
	...
	case 'sentbox' :
		...
		<?php if ( bp_is_messages_inbox() ) : ?>
			<h2 class="bp-screen-reader-text"><?php
				...
				_e( 'Messages inbox', 'besocial' );
			?></h2>
		<?php elseif ( bp_is_messages_sentbox() ) : ?>
			<h2 class="bp-screen-reader-text"><?php
				/* translators: accessibility text */
				_e( 'Sent Messages', 'besocial' );
			?></h2>
		<?php endif; ?>

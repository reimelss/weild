...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/general'; ?>" method="post" class="standard-form" id="settings-form">
	...
	<?php if ( !is_super_admin() ) : ?>
		...
		<label for="pwd"><?php esc_html_e( 'Current Password <span>(required to update email or change current password)</span>', 'besocial' ); ?></label>
		<input type="password" name="pwd" id="pwd" size="16" value="" class="settings-input small" <?php bp_form_field_attributes( 'password' ); ?>/> &nbsp;<a href="<?php echo wp_lostpassword_url(); ?>" title="<?php esc_attr_e( 'Password Lost and Found', 'besocial' ); ?>"><?php esc_html_e( 'Lost your password?', 'besocial' ); ?></a>

	<?php endif; ?>

	<label for="email"><?php esc_html_e( 'Account Email', 'besocial' ); ?></label>
	...
	<label for="pass1"><?php esc_html_e( 'New Password', 'besocial' ); ?></label>
	...
	<label for="pass2"><?php esc_html_e( 'Repeat New Password', 'besocial' ); ?></label>
	...
	<div class="submit">
		...
		<input type="submit" name="submit" value="<?php esc_attr_e( 'Save Changes', 'besocial' ); ?>" id="submit" class="auto" />
	</div>

...
<div class="buddypress-holder">
	...
	<div class="item-list-tabs activity-type-tabs" aria-label="<?php esc_attr_e( 'Sitewide activities navigation', 'besocial' ); ?>" role="navigation">
		<ul>
			...
			<li class="selected" id="activity-all"><a href="<?php bp_activity_directory_permalink(); ?>"><?php printf( __( 'All Members %s', 'besocial' ), '<span>' . bp_get_total_member_count() . '</span>' ); ?></a></li>
            <?php } ?>

...
<h2 class="bp-screen-reader-text"><?php esc_html_e( 'Manage Members', 'besocial' ); ?></h2>
...
<div aria-live="polite" aria-relevant="all" aria-atomic="true">
                    ...
                    <div class="besocial-member-inner">
						...
						<div class="besocial-member-action">
							<?php if ( count( bp_group_admin_ids( false, 'array' ) ) > 1 ) : ?>
								<a class="button confirm admin-demote-to-member" href="<?php bp_group_member_demote_link(); ?>"><?php esc_html_e( 'Demote to Member', 'besocial' ); ?></a>
							<?php endif; ?>
				...
				<?php while ( bp_group_members() ) : bp_group_the_member(); ?>
					<li>
						...
						<div class="action">
							...
							<a class="button confirm mod-demote-to-member" href="<?php bp_group_member_demote_link(); ?>"><?php esc_html_e( 'Demote to Member', 'besocial' ); ?></a>
	...
	<div class="bp-widget group-members-list">
		<h3 class="section-header"><?php esc_html_e( "Members", 'besocial' ); ?></h3>
                    ...
                    <div class="besocial-member-inner <?php bp_group_member_css_class(); ?>">
						...
						<div class="besocial-member-action">
							<?php if ( bp_get_group_member_is_banned() ) : ?>
								...
								<a href="<?php bp_group_member_unban_link(); ?>" class="button confirm member-unban" title="<?php esc_attr_e( 'Unban this member', 'besocial' ); ?>"><?php esc_html_e( 'Remove Ban', 'besocial' ); ?></a>
		...
		<?php else: ?>
			...
			<div id="message" class="info">
				<p><?php esc_html_e( 'No group members were found.', 'besocial' ); ?></p>
			</div>

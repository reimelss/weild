...
<div class="buddypress-holder">
	...
	<div id="item-nav">
		<div class="item-list-tabs no-ajax" id="object-nav" aria-label="<?php esc_attr_e( 'Group primary navigation', 'besocial' ); ?>" role="navigation">
			<ul>
        ...
        <div id="item-group-admins">
			...
			<?php if ( bp_group_is_visible() ) : ?>
				...
				<h3><?php esc_html_e( 'Group Admins', 'besocial' ); ?></h3>
				...
				if ( bp_group_has_moderators() ) :
					...
					<h2><?php esc_html_e( 'Group Mods' , 'besocial' ); ?></h2>
        ...
        <div id="besocial-bp-widgets">   
            <?php if ( is_active_sidebar( 'besclwpgroupwidgets' ) ) { dynamic_sidebar( 'besclwpgroupwidgets' ); } ?>   
        </div> 
	</div><!-- #item-nav -->
	...
	<div id="item-body">
        ...
        <div id="besocial-bp-widgets-mobile">   
            <?php if ( is_active_sidebar( 'besclwpgroupmobile' ) ) { dynamic_sidebar( 'besclwpgroupmobile' ); } ?>   
        </div>
	</div><!-- #item-body -->

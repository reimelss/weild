...
<?php $besclwp_featured = get_post_meta( get_the_id(), 'besclwp_cmb2_featured', true ); ?>
...
<?php 
if ((has_post_thumbnail()) && ($besclwp_featured == 'standard')) {
...
<?php if ((!empty($besclwp_animated_gif)) && ($besclwp_featured == 'gif')) { ?>     
<div class="besclwp-post-format-img">

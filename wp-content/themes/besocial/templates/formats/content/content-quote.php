...
<div class="besclwp-page-title besclwp-page-quote-title">
...
<?php if (!empty($besclwp_subtitle)) { ?>
    <p class="besclwp-subtitle">
        <span><?php echo stripslashes(esc_attr($besclwp_subtitle)); ?></span>
    </p>
    <?php } ?>
</div>
<?php } ?>
    ...
    <div class="besclwp-post-top-bar"> 
        <div class="besclwp-post-top-bar-inner">
            <div class="besclwp-single-post-date">
                <i class="fa fa-clock-o"></i> <?php echo esc_attr(the_time(get_option('date_format'))); ?>
            </div>

...
/**
 * Module to handle groups tab visibility
 *
 * Class BP_Profile_Visibility_Groups_Helper
 */
class BP_Profile_Visibility_Groups_Helper {
	 ...
	 * Singleton.
	 *
	 * @var BP_Profile_Visibility_Groups_Helper
	 */
	 ...
	 * Get singleton.
	 *
	 * @return BP_Profile_Visibility_Groups_Helper
	 */
	...
	private function setup() {
		add_action( 'bp_groups_setup_nav', array( $this, 'hide_nav' ) );
	}
	...
	public function hide_nav() {
		...
		$privacy = bp_profile_visibility_get_settings( $displayed_user_id, 'bp_profile_group_tab_visibility' );
...
BP_Profile_Visibility_Groups_Helper::get_instance();
